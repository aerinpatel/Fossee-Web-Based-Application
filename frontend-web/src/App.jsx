...
function App() {
    ...
    useEffect(() => {
        ...
        if (savedUser && savedToken) {
            ...
            setAuthToken(savedToken); // Ensure token is set for API calls
        }
    }, []);
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                    ...
                    <div className="w-full max-w-md relative z-10">
                        ...
                        >
                            ...
                            <span className="text-2xl font-bold tracking-tight text-slate-900">FlowDrishti</span>
                        </motion.div>
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden">
                <nav className="h-16 border-b border-slate-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-8 shrink-0 z-50 sticky top-0">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="font-bold text-lg tracking-tight text-slate-900">FlowDrishti</span>
                    </div>
